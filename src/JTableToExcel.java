...
class JTableToExcel extends JFrame{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4145302290258083473L;
...
//		    UIManager.setLookAndFeel("javax.swing.plaf.nimbus.NimbusLookAndFeel"); // Nimbus Theme
		} catch (Exception e) {
		    e.printStackTrace();
		}
...
//                    System.out.println(fc.getSelectedFile().getParentFile().getPath());
...
//					}
					...
					toExcel(table, new File(path + "/" + filename + ".xls"));
				}
			}
		}
	}
